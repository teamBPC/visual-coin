...
const MypageInvestContainer = styled.div``;
const MypageInvestInner = styled.div`
  display: grid;
  grid-template-columns: repeat(5, 1fr);
  gap: 1rem;
`;
const MyInvestItem = styled.div`
  display: flex;
...
function MypageInvest() {
  return (
    <MypageInvestContainer>
      <MypageInvestInner>{CreateMyInvestItem()}</MypageInvestInner>
    </MypageInvestContainer>
  );
}
